...
function GalleryScene({
    ...
    const handleWheel = useCallback(
        (event) => {
            // event.preventDefault(); // Removing preventDefault to not block page scrolling completely if desired
    ...
    useEffect(() => {
        ...
        if (canvas) {
            canvas.addEventListener('wheel', handleWheel, { passive: true }); // Changed to passive
